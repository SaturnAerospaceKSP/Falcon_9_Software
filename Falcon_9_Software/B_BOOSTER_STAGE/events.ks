...
GLOBAL FUNCTION _BOOSTER_LANDING_BURN
{
   // LANDING BURN STARTUP
        ...
        LOCK STEERING TO _LANDING_ZONE_GUIDANCE().
        LOCK THROTTLE TO _BURN_THROTTLE + 0.3. // Start Landing Burn with extra power to be finished early
    ...
    // REST OF LANDING BURN
        ...
        {
            SET _ANGLE_OF_ATTACK_LIMIT TO -(ALT:RADAR / 100) - 0.25. // 100 Meters = 0 AOA, 200 = - 1 etc.
        ...
        LOCK THROTTLE TO _BURN_THROTTLE + 0.225. // Higher throttle for early burn
